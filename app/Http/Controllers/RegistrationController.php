...
class RegistrationController extends Controller
{
    ...
    public function store(Request $request, $competitionId)
    {
        ...
        $validated = $request->validate([
            ...
            'venue_coordinator_name' => ['required', 'string', 'max:255'],
            'venue_coordinator_phone' => ['required', 'string', 'max:20'],
        ...
        $team = Team::create([
            ...
            'venue_coordinator_name' => $validated['venue_coordinator_name'],
            'venue_coordinator_phone' => $validated['venue_coordinator_phone'],
            'status' => 'pending',
            'terms_agreed' => true,
            'terms_agreed_at' => now(),
