...
<head>
    ...
    <style>
        ...
        .error-icon { font-size: 4rem; color: #6c757d; }
    </style>
</head>
<body>
    <div class="error-card">
        <div class="card shadow-sm border-0">
            <div class="card-body p-5">
                ...
                <h2 class="fw-bold text-secondary mb-3">Something Went Wrong</h2>
                <p class="text-muted mb-4">We are sorry, something unexpected happened. Please try again later or contact <strong>Super Admin JBFA</strong> if the problem continues.</p>
