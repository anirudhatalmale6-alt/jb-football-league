            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control @error('ic_number') is-invalid @enderror" id="ic_number" name="ic_number"
                           value="{{ old('ic_number', $player->ic_number) }}" placeholder="XXXXXX-XX-XXXX" maxlength="14">
                    @error('ic_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror" id="date_of_birth" name="date_of_birth"
                           value="{{ old('date_of_birth', $player->date_of_birth?->format('Y-m-d')) }}"@if(Auth::user()->isTeamManager()) readonly @endif>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-calculate on page load if IC already has value
